...
public class MessageContainer {
     ...
     */
    private static final ConcurrentHashMap<String, BlockingQueue<Group>> QNAME_GROUP = new ConcurrentHashMap<>();
    ...
    public static void listenQueue(String queueName, Group group) {
        ...
        BlockingQueue<Group> groups = QNAME_GROUP.get(queueName);
        groups.add(group);
    }
    ...
    private static void checkQueue(String queueName) {
        ...
        try {
            ...
            if (messages == null) {
                ...
                BlockingQueue<Group> groups = new LinkedBlockingQueue<>();
